...
- Preserve UAE calibration for heat and AC assumptions unless the project scope changes.
...
- Write directional tests for every major factor: dataset speed, mode, traffic, plus fuzzy temperature and AC.
