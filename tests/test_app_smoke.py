from src.app import build_dashboard_payload, load_dashboard_dataset, load_dashboard_processed_dataset
...
def test_load_dashboard_processed_dataset_surfaces_missing_processed_file() -> None:
    dataset, error_message = load_dashboard_processed_dataset("missing_processed.csv")
    assert dataset is not None or error_message is not None
